...
declare module uniLib {
    class GameModuleUtils {
        ...
        static LoadGame(url: string, docClassStr: string, params?: IGameConfig, loadingGameUI?: any, callBack?: Function, obj?: any, autoHideLoadUI?: boolean): void;
...
declare module uniLib {
    class UniDragon {
        ...
        lastmsec: number;
        tick: number;
        timer: uniLib.UniTimer;
        constructor(stageObj: egret.DisplayObjectContainer, armature: dragonBones.Armature, msec: number);
        private advanceTime();
        onComplete(): void;
        stop(): void;
    }
    function SetUniDragonTimeout(stageObj: egret.DisplayObjectContainer, armature: dragonBones.Armature, msec: number): UniDragon;
}
    ...
    class ZQGameSdk {
       ...
       */
        ...
        */
         ...
         * 获取原生层宽高
         */
        static NATIVE_WIDTH_HEIGHT: string;
        ...
        /**设置自动旋转 */
        static setAutoRotate(autoRotate?: boolean): void;
        /**获取自动旋转 */
        static getAutoRotate(call?: Function, thisObj?: any): void;
        /**
         * 本地消息推送
         * @param title
         * @param txt
         ...
         * @param thisObj
         */
        static getNativeWH(onBack?: Function, thisObj?: any): void;
        /**
         * 激活扬声器
         */
         ...
         * @param faorce 强制定位模式
         */
        static getLocation(onGetLocation?: Function, thisObj?: any, force?: boolean): Location;
        /**
         * 更新zip包
         * @param zipName
         * @param zipBinStr
